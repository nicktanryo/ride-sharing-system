    ...
    public static void createTables() {
        ...
        try{
            ...
            if (Integer.parseInt(numberOfTables) > 0) {
                ...
                String createTripTable = "create table trip(id integer unsigned not null auto_increment, driver_id integer unsigned, passenger_id integer unsigned, start_location varchar(20) not null, destination varchar(20) not null, start_time DATE, end_time DATE, fee integer, primary key(id), foreign key(driver_id) references driver(id), foreign key(passenger_id) references passenger(id), foreign key(start_location)  references taxi_stop(name), foreign key(destination) references taxi_stop(name));";
